...
const deleteOne = async (params) => {
    ...
    // check
    let isExistCategory = await categoryModel.find({ _id: validId }).count()
    ...
    return await categoryModel.findByIdAndRemove(validId)
}
...
const updateOne = async (params, data) => {
    ...
    return await categoryModel.findByIdAndUpdate(validId, data, { new: true })
}
module.exports = {
    create,
    updateOne,
